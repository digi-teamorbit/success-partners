...
Route::get('/aboutus','HomeController@about')->name('aboutuspage');
Route::get('/work-with-us','HomeController@work_with_us')->name('workwithus');
Route::get('/our-team','HomeController@team')->name('our_team');
Route::get('/our-services','HomeController@services')->name('our_services');
Route::get('/our-partners','HomeController@partners')->name('our_partners');
Route::get('/our-clients','HomeController@clients')->name('our_clients');
Route::get('/contact-us','HomeController@contact')->name('contact_us');
Route::get('/blogs','HomeController@blog')->name('blogs');
Route::get('/blogs/{blogs}','HomeController@showblogdetail')->name('blog_detail');
...
Route::resource('admin/newssection', 'Admin\\NewssectionController');